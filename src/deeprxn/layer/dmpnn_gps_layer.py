...
class DMPNNGPSLayer(MPNNLayerBase):
    def __init__(
        self,
        in_channels,
        out_channels,
        ...
        self.edge_to_node = nn.Linear(out_channels * 2, out_channels)
    ...
    def forward(self, batch):
        ...
        local_out.q = torch.cat([local_out.x, s], dim=1)
        local_out.x = F.relu(self.edge_to_node(local_out.q))
