...
from chemtorch.components.layer.gnn_layer.gnn_block.gnn_block import GNNBlock
from chemtorch.components.layer.gnn_layer.graph_conv.dmpnn_conv import DMPNNConv
from chemtorch.components.layer.utils import normalize
...
class DMPNNBlock(GNNBlock):
    ...
    def forward(self, batch: Batch) -> Batch:
        ...
        if self.use_ffn:
            ...
            batch.h = self.ffn_dropout1(self.ffn_act_fn(self.ffn_linear1(batch.h)))
