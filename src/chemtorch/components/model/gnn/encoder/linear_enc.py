...
from chemtorch.components.model.gnn.encoder.linear_edge_enc import LinearEdgeEncoder
from chemtorch.components.model.gnn.encoder.linear_node_enc import LinearNodeEncoder
