...
class GPSLayer(nn.Module):
   """Graph Transformer layer with local and global processing."""
   ...
   def __init__(
       ...
       mpnn_cfg : dict
           Configuration for the local message passing network.
       att_layer_cfg : dict
       ...
       dropout : float
           Dropout probability.
       log_attn_weights : bool, optional
           Whether to log attention weights, by default False.
       dataset_precomputed : str, optional
           Name of dataset with precomputed features, by default None.
