...
class GINEConvESLapPE(pyg_nn.conv.MessagePassing):
   ...
   def __init__(
       ...
       **kwargs,
       ...
       """Initialize the GINEConv layer with EquivStableLapPE.
       ...
       eps : float, optional
           The epsilon value, by default 0.0.
       train_eps : bool, optional
           Whether to make epsilon a trainable parameter, by default False.
       edge_dim : int, optional
           The edge feature dimension, by default None.
       **kwargs
           Additional arguments for the MessagePassing base class.
