...
class FeaturizerBase(AbstractFeaturizer, Generic[T]):
    ...
    def __init__(self, features: List[Callable[[T], Any] | Tuple[Callable[[T], Any], List]]):
        """
        ...
        Args:
            features (List[Callable | Tuple[Callable, List]]): A list of features to be extracted. Please
                refer to `deepreaction.featurizer.utils.featurize` for details on the expected format.
        """
