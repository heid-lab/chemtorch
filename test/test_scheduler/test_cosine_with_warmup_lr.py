...
from deepreaction.scheduler.cosine_with_warmup_lr import CosineWithWarmupLR

# Previously hard-coded implementation of cosine with warmup
def reference_cosine_with_warmup_lambda(num_warmup_steps, num_training_steps, num_cycles=0.5):
...
@pytest.mark.parametrize("num_warmup_steps,num_training_steps", [
    (10, 100),
    (5, 20),
    (0, 50),
])
